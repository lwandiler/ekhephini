  ...
  return (
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-12">
          {currentShow ? (
            <Card className="overflow-hidden hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-primary/20 to-muted border-primary/30">
              <div className="flex flex-col md:flex-row">
                <div className="md:w-2/5 relative group">
                  <div className="w-full h-64 md:h-full bg-gradient-to-br from-primary/30 to-primary/10 flex items-center justify-center">
                    <div className="text-center">
                      <Radio className="w-16 h-16 text-primary mx-auto mb-4" />
                      <div className="text-primary font-semibold">LIVE RADIO</div>
                    </div>
                  </div>
                  <div className="absolute inset-0 bg-gradient-to-r from-primary/20 to-transparent md:bg-gradient-to-t md:from-background/80 md:via-background/40 md:to-transparent"></div>
                  <Button className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-primary hover:bg-primary/90 text-primary-foreground h-16 w-16 rounded-full opacity-90 group-hover:opacity-100 transition-all duration-300">
