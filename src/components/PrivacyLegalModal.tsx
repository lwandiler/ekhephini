...
const PrivacyLegalModal = ({ children }: PrivacyLegalModalProps) => {
  return (
    <Dialog>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Ekhephini FM operates under the appropriate broadcasting licenses 
...
export default PrivacyLegalModal;