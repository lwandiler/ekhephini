                ...
                <div>
                  ...
                  <Select name="category" defaultValue={editingAnnouncement?.category || ''}>
                    ...
                    <SelectContent className="!bg-white !border !border-gray-300 !shadow-lg !z-50">
                      <SelectItem value="Technical" className="!text-black !bg-white hover:!bg-gray-100">Technical</SelectItem>
                      <SelectItem value="Programming" className="!text-black !bg-white hover:!bg-gray-100">Programming</SelectItem>
                      <SelectItem value="Community" className="!text-black !bg-white hover:!bg-gray-100">Community</SelectItem>
                      <SelectItem value="Events" className="!text-black !bg-white hover:!bg-gray-100">Events</SelectItem>
                      <SelectItem value="General" className="!text-black !bg-white hover:!bg-gray-100">General</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
