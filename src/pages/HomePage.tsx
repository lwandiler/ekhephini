...
const HomePage = () => {
  ...
  // Force dark mode OFF to ensure white background
  useEffect(() => {
    if (isDarkMode) {
      toggleDarkMode();
    }
  ...
  return (
    <InlineEditProvider>
      <div className={`flex flex-col min-h-screen font-${themeOptions.fontFamily} text-size-${themeOptions.fontSize} bg-white`}>
        <Header />
