...
const CatchUp = () => {
  return <div className="w-full min-h-screen bg-white font-asap">
      ...
      <section className="relative w-full h-[400px] overflow-hidden">
        {/* Background Image */}
        <img src="https://api.builder.io/api/v1/image/assets/TEMP/e154fb9d1aed06944969aa7592132dfc209c4bc2?width=2928" alt="Catch Up Background" className="absolute -left-3 top-0 w-full h-full object-cover backdrop-blur-[50px]" />
